 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "NeighborsBackend.mymodule.example.com", ownerName = "NeighborsBackend.mymodule.example.com", packagePath=""))
